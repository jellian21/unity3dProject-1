...
public class PaperCycleManager3: MonoBehaviour {
...
*/
	...
	/*public void OrigamiOutcome()
	{
		if (scoreCount >= 5) {
			int indexFinal = 0;
			theOrigami=origamiIndex[indexFinal];
			OrigamiFinish.sprite = theOrigami.origamiF;
			indexFinal++;
